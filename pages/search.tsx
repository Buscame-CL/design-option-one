...
const Search = ({ results }) => {
  ...
  return (
    <div className="app" ref={appDiv}>
      <Head>
        <title>{router.query.q} - Buscame.CL Search</title>
        <link
          rel="icon"
          href="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Buscame.CL_%22G%22_Logo.svg/160px-Buscame.CL_%22G%22_Logo.svg.png"
        />
      </Head>
...
export const getServerSideProps = async (context) => {
  ...
  const data = await fetch(
    `https://www.Buscame.CLapis.com/customsearch/v1?key=${process.env.CSE_API_KEY}&cx=${process.env.CSE_CONTEXT_KEY}&q=${context.query.q}&start=${startIndex}`
